    ...
    'components' => [
        ...
        'urlManager' => [
            'rules'=> [
                ...
                'list/<category_id:\d+>'  => 'list/index',
                'turboshop/tuning'  => 'list/tuning',
                'turboshop/refurbish' => 'list/refurbish',
                // 'turboshop/cartridges' => 'list/cartridges',
                'turboshop/sparepart/<alias:>' => 'list/sparepart',
                'turboshop/manufacturers/<manufacturer_alias:>' => 'list/index',
                'turboshop/<category_alias:>/<brand_alias:>/<model_alias:>' => 'list/index',
                'turboshop/<category_alias:>/<brand_alias:>'  => 'list/index',
                'turboshop/<category_alias:>'  => 'list/index',
