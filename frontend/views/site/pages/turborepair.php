...
$this->registerMetaTag([
    'name' => 'description', 
    'content' => 'Ремонт турбин только после полной диагностики, расширенная гарантия на турбокомпрессор и на выполненные работы.']);
$this->registerMetaTag([
    'name' => 'keywords', 
...
<div class="container page-style">
    <div class="row">
        <div class="col-md-9">
            ...
            <h1>ТурбоРемонт<?= isset($_GET['name']) ? ' для ' .$_GET['name'] : '' ?></h1>
...
<br>
<a class="underline" href="/repair-price">Стоимость ремонта турбины</a>
<br>
<br>
