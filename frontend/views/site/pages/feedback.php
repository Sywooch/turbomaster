    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <article>
                ...
                <section id="reviews">
                    <ul>
                        <li>Партнеры, спасибо за помощь с ремонтом турбин на бэху Х5М. Оперативно, качественно, недорого. Если что - обращайтесь! <span>Техцентр БМВ-Север., 09.09.2013</span>
                        </li>
                        <li>Турбину получил и уже поставил. Мой Паджерик снова гоняет! Спасибо! <span>Верховодов, 09.09.2013</span>
                        </li>
                        <li>
