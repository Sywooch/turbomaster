...
$this->title = 'Ремонт турбин - ТурбоМастер.ру, ремонт турбин дизельных двигателей в Москве';
$this->registerMetaTag([
    'name' => 'description', 
    'content' => 'Профессиональный ремонт турбин дизельных двигателей. Работаем с автомобилями любых марок и любого года выпуска! Цены на ремонт турбин, описание работ. Расширенная общая гарантия на турбокомпрессор и на выполненные работы.']);
$this->registerMetaTag([
    'name' => 'keywords', 
    'content' => 'ремонт турбин, ремонт дизельных турбин, ремонт турбин дизельных двигателей, ремонт турбокомпрессоров, турборемонт, турбомастер']);
?>
...
<div class="container page-style">
    <div class="row">
        <div class="col-md-9">
            <section id="breadcrumbs">
                <?= Breadcrumbs::widget([
                  ...
                  'links' => [['label' => 'ТурбоРемонт'], ['label' => 'Стоимость ремонта турбины']]]) ?>
            </section>
        ...
        <p></p>
        <p><span style="font-size: 1.5em;">Фоторепортаж из нашего техцентра:</span></p>
        <p></p>
