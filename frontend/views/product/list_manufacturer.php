...
if($manufacturer_alias == 'borg_warner_schwitzer_3k') {  ?>
  ...
  <section id="list_a">
    ...
    <h2>Все турбины KKK / Borg Warner / Schwitzer:</h2>

<?php
} elseif($manufacturer_alias == 'honeywell_garrett') {  ?>
  ...
  <section id="list_a">
    ...
    <h2>Все турбины Honeywell/Garrett:</h2>

<?php 
} else { 
  echo "
    <h1 class=\"catalog\">Все турбины $manufacturer_name:</h1>
  </section>
