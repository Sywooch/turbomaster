...
$this->title = 'Каталог актуаторов для турбин - Турбомастер.ру, продажа турбин и запчастей к ним с доставкой по Москве и России, диагностика и ремонт турбин';
$this->registerMetaTag(['name' => 'description', 'content' => 'Каталог актуаторов для турбин. Бесплатная доставка по Москве. Оперативная доставка во все регионы России!']);
$this->registerMetaTag(['name' => 'keywords', 'content' => 'актуатор, актюаторы для турбин, запчасти для турбин']);
?>
...
<div class="container page-style">
    <section id="breadcrumbs">
        <?= Breadcrumbs::widget([
          ...
          'links' => [
            ['label' => 'ТурбоМагазин'],
            ['label' => 'Актуаторы для турбин'],
        ]]) ?>
    </section>
    
    <h1 class="catalog">Актуаторы для турбин</h1>
