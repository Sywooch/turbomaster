...
<body>
    ...
    <script type="text/javascript">document.write('<script type="text/javascript" charset="utf-8" async="true" id="onicon_loader" src="http://cp.onicon.ru/js/simple_loader.js?site_id=552fd2d42866887e278b457b&srv=1&' + (new Date).getTime() + '"></scr' + 'ipt>');</script>
</body>
</html>
<?php $this->endPage() ?>
