						...
						var fileOutput = function() {
							...
							el.on('change.styler', function() {
								...
								if (value === '') {
									...
									// oleg add: callback after select file
									var parentForm = $(this).parents('form');
									parentForm.children(('input[type="submit"], button')).show().prop('disabled', false);
									// end add
					...
					if (el.parent('div.jqselect').length < 1) {
						...
						var selectboxOutput = function() {
							...
							function doSelect() {
								...
								// var selCloneWidth = selClone.width(60);
								// selClone.remove();
								// if (selCloneWidth == selectbox.width()) {
								// 	divText.width(liWidth2);
								// 	liWidth1 += selectbox.find('div.jq-selectbox__trigger').width(100);
								// }
