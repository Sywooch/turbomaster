...
?>
 <!-- section with right thumb -->
    <tr>
      ...
      <table class="emailBlock" align="left" width="400" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
        <tr>
          ...
          <tr>
            <td  class="emailCopy" style="font-family:'Open Sans',Arial,sans-serif;color:#262626; padding-top: 35px; padding-bottom:0; padding-right:0; padding-left:0;">
              <table border="0" cellpadding="2" cellspacing="0" style="font-family:'Open Sans',Arial,sans-serif; color:#262626; font-size: 20px; line-height:24px;">
                <tr>
                  <td colspan="2" style="padding-bottom: 40px; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color:#dddddd;">На сайте <?= $message ?>: &nbsp;&nbsp;
                ...
                <tr>
                  ...
                  <td style="padding-bottom: 30px;"><b><?= $question['email'] ?></b></td>
                </tr>
                <tr>
